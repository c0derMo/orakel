<template>
    <div class="tb-item-teams">
        <div>
            ...
            <div
              :class="['tb-team', 'tb-team-top', getPlayerClass(bracketNode.match.team1.id)]"
            ...
            <div
              :class="['tb-team', 'tb-team-bot', getPlayerClass(bracketNode.match.team2.id)]"
...
export default {
    ...
    methods: {
        getPlayerClass(teamId) {
            let cl = "";
            if(this.bracketNode.match.winner !== undefined && this.bracketNode.match.winner == teamId) {
                cl += " winner";
            }
